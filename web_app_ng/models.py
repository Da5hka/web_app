...
class related_papers(models.Model):
    ...
    description_ng_papers =  models.TextField(blank=True, null=True)
    ...
    picture_mnnog = models.ImageField(upload_to='images_data_mnnog/', height_field=None, width_field=None, max_length=256, blank=True, null=True)
